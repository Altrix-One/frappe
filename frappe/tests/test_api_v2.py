...
from frappe.tests.test_api import AltrixAPITestCase, suppress_stdout
...
class TestResourceAPIV2(AltrixAPITestCase):
	version = "v2"
	DOCTYPE = "ToDo"
...
class TestMethodAPIV2(AltrixAPITestCase):
	version = "v2"
...
class TestDocTypeAPIV2(AltrixAPITestCase):
	version = "v2"
