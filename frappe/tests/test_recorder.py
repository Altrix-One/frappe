# Copyright (c) 2019, Altrix Technologies Pvt. Ltd. and Contributors
...
class TestRecorder(AltrixTestCase):
	def setUp(self):
...
class TestRecorderDeco(AltrixTestCase):
...
class TestQueryNormalization(AltrixTestCase):
